...
<%
	...
	ReGongjiService gongjiService = new ReGongjiService(); // gongjiSerive 객체 생성
...
<h1><p align="center" style="font-family: 'Noto Serif KR', serif;">이용 후기 수정</p></h1>
	<form name="fsf" method="post" onsubmit="return check();">
		...
		<table width=50% align="center">
			<tr>
				<td width=50% align="right"><input class="btn btn-default" type="button" value="취소" onclick="location.href='e_02.jsp'"><button class="btn btn-default" type="submit" onclick="submitForm('write')">쓰기</button></td>
			</tr>
		</table>
	</form>
</body>
