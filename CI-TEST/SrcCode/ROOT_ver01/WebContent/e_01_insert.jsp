...
<body link="black" vlink="black">
	<h1><p align="center" style="font-family: 'Noto Serif KR', serif;">게시물 작성</p></h1>
	<!-- 번호, 제목, 일자, 내용 출력 -->
	<form name="frm" method="post" action="e_01_write.jsp" onsubmit="return check();" enctype="multipart/form-data">
		<table class="table table-bordered" style="width:50%; background-color:#ffffff" border=1 align="center" cellpadding=1 cellspacing=1>
			<tr>
				<td width=180px align="center">번호</td>
				<td width=600px>신규(insert)<input type="hidden" name="id" value="insert"></td>	
			</tr>	
			<tr>
				<td align="center">제목</td>
				<td><input type="text" name="title" size=90 maxlength=80 autocomplete="off" style="background-color:transparent;"></td>	
			</tr>	
			<tr>
			...
			<tr>
				...
				<td><textarea name="content" cols="92" rows="20" autocomplete="off" style="background-color:transparent;"></textarea></td>	
			</tr>
			<tr>
		...
		<table border=0 width=50% align="center">
			<tr>
				<td width=50% align="right"><input class="btn btn-default" type="button" value="취소" onclick="location.href='e_01.jsp'"><button class="btn btn-default" type="submit">쓰기</button></td>
			</tr>
		</table>
	</form>
</body>
